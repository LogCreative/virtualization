...
# wget https://mirror.sjtu.edu.cn/ubuntu-cd/18.04.6/ubuntu-18.04.6-live-server-amd64.iso
# qemu-system-x86_64 -m 2048 -nographic ubuntu.img -cdrom ./ubuntu-18.04.6-live-server-amd64.iso
